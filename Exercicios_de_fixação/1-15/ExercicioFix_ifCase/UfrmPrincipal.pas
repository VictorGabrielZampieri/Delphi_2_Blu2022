...
begin
  ...
  case TNivel(rgNivel.ItemIndex) of
    ...
    opEstagiario:
    begin
      ShowMessage('Eu ' + xNome + ' sou do nível Estagiário.');
    end;

    opJunior:
    begin
      ShowMessage('Eu ' + xNome + ' sou do nível Júnior.');
    end;

    opPleno:
    begin
      ShowMessage('Eu ' + xNome + ' sou do nível Pleno.');
    end;

    opSenior:
    begin
      ShowMessage('Eu ' + xNome + ' sou do nível Sênior.');
    end;
  end;
end;
