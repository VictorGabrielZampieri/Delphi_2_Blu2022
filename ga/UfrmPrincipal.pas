...
begin
  ...
  ShowMessage('Você não possui Saldo para comprar maçãs, Parabéns!')
end;
...
begin
   ...
   xMacas := StrToInt(lbtQuantidade.Caption);
    ...
    if (xMacas - 50 >= 0) then
     ...
     ShowMessage('Você não possui Maçãs o suficiente');
...
begin
  ...
  if (xCaixa > 0) then
    begin
     ...
     ShowMessage('Você Não possui caixas para vender');
