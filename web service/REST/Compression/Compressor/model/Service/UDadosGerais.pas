...
type
  TDadosGerais = class
    ...
    public
      ...
      function RemoverRegistro(const aIndentificador: Integer): Boolean;
...
begin
  ...
  try
    try
      ...
      on E: Exception do
        raise Exception.Create('Nâo foi possível Carregar od Dados '+ E.Message);
    end;
  finally
...
function TDadosGerais.RemoverRegistro(const aIndentificador: Integer): Boolean;
var
  I: Integer;
  xJSON: TJSONObject;
begin
