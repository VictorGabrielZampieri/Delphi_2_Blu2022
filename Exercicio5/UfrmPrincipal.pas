...
begin
 { case cmbAnimal.ItemIndex of
  ...
  1: //Pássaro
begin
    mmHistorico.Lines.Add('Sou um pássaro e tenho duas patas.');
end;
  2: //Gato
  begin
  ...
  begin
    mmHistorico.Lines.Add('Não foi definido nenhum animal.');
     ...
     QueAnimalSouEu;//chamando a funcção quanto apertar o botao
end;
...
begin
  ...
  tpPassaro:
begin
   xfrase :=  'Sou um pássaro e tenho duas patas.';
end;
  tpGato:
  begin
