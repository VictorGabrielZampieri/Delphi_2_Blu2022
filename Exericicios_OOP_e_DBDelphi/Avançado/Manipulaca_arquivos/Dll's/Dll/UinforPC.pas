    ...
    1:
      ...
      2:
       begin
         case VersionInfo.dwMajorVersion of
            3:
              Result := 'Windows NT ' + IntToStr(VersionInfo.dwMajorVersion) + '.' + IntToStr(VersionInfo.dwMinorVersion);
            4:
              Result := 'Other Windows ' + IntToStr(VersionInfo.dwMajorVersion) + '.' + IntToStr(VersionInfo.dwMinorVersion);
            5:
            begin
            ...
            6:
              Result := 'Windows 7 ' + IntToStr(VersionInfo.dwMajorVersion) + '.' + IntToStr(VersionInfo.dwMinorVersion);
            7:
              Result := 'Windows 8 ' + IntToStr(VersionInfo.dwMajorVersion) + '.' + IntToStr(VersionInfo.dwMinorVersion);
            8:
              Result := 'Windows vVista ' + IntToStr(VersionInfo.dwMajorVersion) + '.' + IntToStr(VersionInfo.dwMinorVersion);
            10:
              Result := 'Windows 10 ' + IntToStr(VersionInfo.dwMajorVersion) + '.' + IntToStr(VersionInfo.dwMinorVersion);
            else
              Result := 'Não achei a Versão';
         end;
