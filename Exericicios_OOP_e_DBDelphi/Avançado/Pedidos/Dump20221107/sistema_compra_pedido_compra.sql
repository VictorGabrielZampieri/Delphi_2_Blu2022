...
CREATE TABLE `pedido_compra` (
  ...
  `idcomprador` int unsigned DEFAULT NULL,
  `idfornecedor` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id_pedido`),
  UNIQUE KEY `numero` (`numero`),
  KEY `idcomprador` (`idcomprador`),
  KEY `idfornecedor` (`idfornecedor`),
  CONSTRAINT `pedido_compra_ibfk_1` FOREIGN KEY (`idcomprador`) REFERENCES `comprador` (`id_comprador`),
  CONSTRAINT `pedido_compra_ibfk_2` FOREIGN KEY (`idfornecedor`) REFERENCES `fornecedor` (`id_fornecedor`)
...
INSERT INTO `pedido_compra` VALUES (1,1,'2000-11-11',4,2),(2,2,'2000-10-22',4,1),(3,123,'2022-11-04',3,2);
